...
export class UserController {
    ...
    async login(
        ...
        const accessToken = await this.userService.verifyUser(
            username,
            password,
            'user',
        )
    ...
    @ApiQuery({
        ...
        required: false,
        description:
            'Returns all users with subscription expiring before current date + expireIn. Must be a positive integer.',
    })
    @ApiQuery({
        name: 'name',
        required: false,
        description:
            'Name of the user. Case-sensitive and must match full string.',
    })
    @ApiQuery({
        name: 'department',
        required: false,
        description:
            'Department of the user. Case-sensitive and must match full string.',
    })
    @Get('')
...
export class AdminController {
    ...
    async login(
        ...
        const accessToken = await this.adminService.verifyUser(
            username,
            password,
            'admin',
        )
